function [position, RT, answer,x] = slideScale_FB(screenPointer, question, rect, endPoints, color, startposition)
...
device        = 'keyboard';
aborttime     = 2;
responseKeys  = [40  KbName('LeftArrow') KbName('RightArrow')];
drawImage     = 0;
...
while answer == 0
    ...
    DrawFormattedText(screenPointer, question, 'center', rect(4)*(scalaPosition - 0.1),color); 
